 ...
 * @access Private
 */
router.get('/collections/:id/works', /* authMiddleware, */ async (req, res) => {
  try {
 ...
 * @access Private
 */
router.post('/collections/:id/works', /* authMiddleware, */ upload.fields([
 ...
 * @access Private
 */
router.put('/works/:id', /* authMiddleware, */ upload.fields([
  { name: 'video', maxCount: 1 },
  { name: 'coverImage', maxCount: 1 }
]), async (req, res) => {
  try {
 ...
 * @access Private
 */
router.delete('/works/:id', /* authMiddleware, */ async (req, res) => {
  try {
    const work = await Work.findById(req.params.id);
    if (!work) {
      return res.status(404).json({
 ...
 * @access Private
 */
router.get('/review/collections', /* authMiddleware, */ async (req, res) => {
  try {
 ...
 * @access Private
 */
router.put('/review/collections/:id', /* authMiddleware, */ async (req, res) => {
  try {
