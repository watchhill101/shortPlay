		...
		<view class="maincontainer">
			<view class="content">
				<view class="goods-swiper" v-if="bannerList.length > 0">
					<swiper :indicator-dots="true" :interval="3000" :duration="1000" indicator-color="#999"
						indicator-active-color="#ba8f40" autoplay="true">
				...
				<block v-for="(colls,index) in playletCollections">
					<view class="playlet-collections" scroll-x>
						...
						<scroll-view class="item" scroll-x="true" show-scrollbar="false">
							<view class="playlet" v-for="(item, index) in colls.playletList" :keys="index"
				...
				<view class="playlet-recommend">
					...
					<view class="item">
						<view class="playlet" v-for="(item, index) in playletRecommends" :keys="index"
							@tap="toPalyletDetail(item)">
							<view class="cover">
