        ...
        >
          <view class="u-calendar-month__days__day__select" :style="[daySelectStyle(index, index1, item1)]">
            ...
            <text
              ...
              :class="[
                item1.disabled || isForbid(item1) ? 'u-calendar-month__days__day__select__buttom-info--disabled' : '',
              ]"
              :style="[textStyle(item1)]"
  ...
  methods: {
    ...
    setDefaultDate() {
      ...
      defaultDate = defaultDate.filter((item) => {
        return (
          dayjs(item).isAfter(dayjs(minDate).subtract(1, 'day')) && dayjs(item).isBefore(dayjs(maxDate).add(1, 'day'))
        );
      });
