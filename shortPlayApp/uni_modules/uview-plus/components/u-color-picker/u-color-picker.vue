<template>
  <view class="up-color-picker">
    <view clas="up-color-picker__trigger" @click="show = true" :style="{ backgroundColor: value }">
      <slot></slot>
    </view>
    <up-popup :show="show" mode="bottom" round="10" @close="close" :closeOnClickOverlay="true">
      <view class="up-color-picker__content">
        ...
        <view v-if="colorTypeIndex == 1" class="up-color-picker__gradient">
          <!-- 渐变色控制条 -->
          <view class="up-color-picker__gradient-track" :style="{ background: gradientStyle }">
            <view
          ...
          <view class="up-color-picker__gradient-controls">
            <up-button type="primary" size="mini" plain @click="addGradientColor" class="up-color-picker__add-btn">
              添加颜色
            </up-button>
          </view>
        ...
        <view class="up-color-picker__solid">
          ...
          >
            <view class="up-color-picker__hue-pointer" :style="{ left: huePosition + 'px' }"></view>
          </view>
          ...
          >
            ...
            <view class="up-color-picker__alpha-pointer" :style="{ left: alphaPosition + 'px' }"></view>
          </view>
        </view>
        ...
        <view class="up-color-picker__footer">
          <view class="up-color-picker__preview">
            <view class="up-color-picker__preview-color" :style="{ backgroundColor: displayColor }"></view>
            <text class="up-color-picker__preview-text">{{ displayColor }}</text>
          </view>
          <view class="up-color-picker__actions">
            <up-button type="primary" size="small" @click="confirm" class="up-color-picker__btn"> 确定 </up-button>
            <up-button type="info" size="small" @click="close" class="up-color-picker__btn"> 取消 </up-button>
          </view>
        </view>
      </view>
    </up-popup>
    ...
    updateSolidColor() {
      ...
      query.exec((res) => {
        ...
        if (this.colorTypeIndex == 0) {
          ...
          this.gradientColors[this.editingGradientIndex].color = this.hslToRgb(
            this.hue,
            this.saturation,
            this.lightness,
            this.alpha,
