 ...
 * Original file: /npm/marked@16.1.2/lib/marked.esm.js
 *
  ...
  let n = 'string' == typeof e ? e : e.source,
    r = {
      replace: (e, t) => {
        ...
        return ((s = s.replace(l.caret, '$1')), (n = n.replace(e, s)), r);
      },
...
var l = {
    ...
    unicodeAlphaNumeric: /[a-zA-Z0-9\u00C0-\u02AF\u0300-\u036F\u0400-\u04FF\u0500-\u052F\u1E00-\u1EFF]/u,
    escapeTest: /[&<>"']/,
    escapeReplace: /[&<>"']/g,
  ...
  I = s(P, 'u').replace(/punct/g, S).getRegex(),
  L = s(P, 'u').replace(/punct/g, _).getRegex(),
  B =
  ...
  C = s(B, 'gu')
    ...
    .getRegex(),
  q = s(B, 'gu')
    .replace(/notPunctSpace/g, /[a-zA-Z0-9\u4e00-\u9fa5~]/)
    .replace(/punctSpace/g, /[\s!"#$%&'()*+,-./:;<=>?@[\]^_`{|}·！￥……（）——《》「」『』【】、；：‘’“”，。、]/)
    .replace(/punct/g, _)
    .getRegex(),
  E = s(
  ...
  G = {
    ...
    punctuation: A,
    reflink: N,
    reflinkSearch: s('reflink|nolink(?!\\()', 'g').replace('reflink', N).replace('nolink', j).getRegex(),
    tag: M,
    text: /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,
    url: r,
  },
  ...
  F = { normal: w, gfm: y, pedantic: $ },
  U = { normal: G, gfm: W, breaks: X, pedantic: H },
  J = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' },
  K = (e) => J[e];
function V(e, t) {
  if (t) {
    if (l.escapeTest.test(e)) return e.replace(l.escapeReplace, K);
  } else if (l.escapeTestNoEncode.test(e)) return e.replace(l.escapeReplaceNoEncode, K);
  return e;
}
function Y(e) {
  try {
...
var re = class {
      ...
      if (t) {
        ...
        for (; e.length > 0; ) {
          ...
          for (t = 0; t < e.length; t++)
            if (this.rules.other.blockquoteStart.test(e[t])) (i.push(e[t]), (l = !0));
            else {
              if (l) break;
              i.push(e[t]);
            }
          ...
          if (
            ((this.lexer.state.top = !0), this.lexer.blockTokens(o, s, !0), (this.lexer.state.top = c), 0 === e.length)
          )
            break;
          let h = s.at(-1);
      ...
      if (t) {
        ...
        for (; e; ) {
          ...
          if (
            (this.options.pedantic
              ...
              : h
                ...
                : ((p = t[2].search(this.rules.other.nonSpaceChar)),
                  ...
                  (a = o.slice(p)),
                  (p += t[1].length)),
            h && this.rules.other.blankLine.test(c) && ((r += c + '\n'), (e = e.substring(c.length + 1)), (n = !0)),
            !n)
          ) {
            ...
            for (; e; ) {
              ...
              if (
                ...
                break;
              if (u.search(this.rules.other.nonSpaceChar) >= p || !c.trim()) a += '\n' + u.slice(p);
              else {
                if (
                  h ||
          ...
          (this.options.gfm &&
            ...
            g && ((u = '[ ] ' !== g[0]), (a = a.replace(this.rules.other.listReplaceTask, '')))),
            s.items.push({ type: 'list_item', raw: r, task: !!g, checked: u, loose: !1, text: a, tokens: [] }),
            (s.raw += r));
        }
        let a = s.items.at(-1);
        if (!a) return;
        ...
        for (let e = 0; e < s.items.length; e++)
          if (
            ((this.lexer.state.top = !1), (s.items[e].tokens = this.lexer.blockTokens(s.items[e].text, [])), !s.loose)
          ) {
            let t = s.items[e].tokens.filter((e) => 'space' === e.type),
              n = t.length > 0 && t.some((e) => this.rules.other.anyLine.test(e.raw));
            s.loose = n;
          }
        if (s.loose) for (let e = 0; e < s.items.length; e++) s.items[e].loose = !0;
        return s;
      }
    }
    html(e) {
    ...
    table(e) {
      ...
      let n = ee(t[1]),
        ...
        s = t[3]?.trim() ? t[3].replace(this.rules.other.tableRowBlankLine, '').split('\n') : [],
  ...
  se = class e {
    ...
    constructor(e) {
      ...
      let n = { other: l, block: F.normal, inline: U.normal };
      (this.options.pedantic
        ? ((n.block = F.pedantic), (n.inline = U.pedantic))
        : this.options.gfm && ((n.block = F.gfm), this.options.breaks ? (n.inline = U.breaks) : (n.inline = U.gfm)),
      ...
      for (this.options.pedantic && (e = e.replace(l.tabCharGlobal, '    ').replace(l.spaceLine, '')); e; ) {
        ...
        if (this.options.extensions?.startBlock) {
          ...
          (this.options.extensions.startBlock.forEach((e) => {
            ((t = e.call({ lexer: this }, r)), 'number' == typeof t && t >= 0 && (n = Math.min(n, t)));
          }),
    ...
    inlineTokens(e, t = []) {
      ...
      for (; e; ) {
        ...
        if ((r = this.tokenizer.reflink(e, this.tokens.links))) {
          e = e.substring(r.raw.length);
          let n = t.at(-1);
          'text' === r.type && 'text' === n?.type ? ((n.raw += r.raw), (n.text += r.text)) : t.push(r);
          continue;
        }
        ...
        if ((r = this.tokenizer.inlineText(i))) {
          ((e = e.substring(r.raw.length)), '_' !== r.raw.slice(-1) && (l = r.raw.slice(-1)), (s = !0));
          let n = t.at(-1);
          'text' === n?.type ? ((n.raw += r.raw), (n.text += r.text)) : t.push(r);
        } else if (e) {
          let t = 'Infinite loop on byte: ' + e.charCodeAt(0);
          if (this.options.silent) {
            console.error(t);
  ...
  le = class {
    ...
    code({ text: e, lang: t, escaped: n }) {
      ...
      return r
        ? '<pre><code class="language-' + V(r) + '">' + (n ? s : V(s, !0)) + '</code></pre>\n'
          ...
          ? 'paragraph' === e.tokens[0]?.type
            ? ((e.tokens[0].text = n + ' ' + e.tokens[0].text),
              e.tokens[0].tokens &&
                ...
                ((e.tokens[0].tokens[0].text = n + ' ' + V(e.tokens[0].tokens[0].text)),
    ...
    link({ href: e, title: t, tokens: n }) {
      ...
      if (null === s) return r;
      let l = '<a href="' + (e = s) + '"';
      return (t && (l += ' title="' + V(t) + '"'), (l += '>' + r + '</a>'), l);
    }
    image({ href: e, title: t, text: n, tokens: r }) {
      r && (n = this.parser.parseInline(r, this.parser.textRenderer));
      let s = Y(e);
      if (null === s) return V(n);
      let l = `<img src="${(e = s)}" alt="${n}"`;
      return (t && (l += ` title="${V(t)}"`), (l += '>'), l);
    }
    text(e) {
      ...
      for (let r = 0; r < e.length; r++) {
        ...
        switch (l.type) {
          ...
          case 'text': {
            ...
            for (; r + 1 < e.length && 'text' === e[r + 1].type; ) ((s = e[++r]), (i += '\n' + this.renderer.text(s)));
            n += t
  ...
  ce = class {
    ...
    use(...e) {
      ...
      return (
        e.forEach((e) => {
          ...
          if (e.tokenizer) {
            let t = this.defaults.tokenizer || new re(this.defaults);
          ...
          if (e.hooks) {
            let t = this.defaults.hooks || new oe();
            for (let n in e.hooks) {
              ...
              let r = n,
                s = e.hooks[r],
                l = t[r];
              oe.passThroughHooks.has(n)
                ? (t[r] = (e) => {
                    if (this.defaults.async) return Promise.resolve(s.call(t, e)).then((e) => l.call(t, e));
                    let n = s.call(t, e);
                    return l.call(t, n);
                  })
                : (t[r] = (...e) => {
    ...
    parseMarkdown(e) {
      return (t, n) => {
        ...
        if (typeof t > 'u' || null === t) return l(new Error('marked(): input parameter is undefined or null'));
        if ('string' != typeof t)
          return l(
            new Error(
        ...
        let i = s.hooks ? s.hooks.provideLexer() : e ? se.lex : se.lexInline,
          a = s.hooks ? s.hooks.provideParser() : e ? ae.parse : ae.parseInline;
        if (s.async)
        ...
        try {
          ...
          let e = i(t, s);
          (s.hooks && (e = s.hooks.processAllTokens(e)), s.walkTokens && this.walkTokens(e, s.walkTokens));
          let n = a(e, s);
