    ...
    onChange(index, event) {
      ...
      if (this.direction === 'all') {
        ...
        if (this.direction === 'vertical') {
          ...
          targetIndex = Math.max(0, Math.min(Math.round(this.currentPosition.y / itemSize), this.list.length - 1));
        } else if (this.direction === 'horizontal') {
          itemSize = this.itemWidth;
          targetIndex = Math.max(0, Math.min(Math.round(this.currentPosition.x / itemSize), this.list.length - 1));
        }
