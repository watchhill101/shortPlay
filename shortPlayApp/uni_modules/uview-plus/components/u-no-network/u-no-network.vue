  ...
  >
    <view class="u-no-network">
      ...
      <view class="u-no-network__app">
        ...
        <text class="u-no-network__app__to-setting" @tap="openSettings">{{ t('up.common.settings') }}</text>
      </view>
      <!-- #endif -->
      <view class="u-no-network__retry">
        <u-button size="mini" :text="t('up.common.retry')" type="primary" plain @click="retry"></u-button>
      </view>
    </view>
  </u-overlay>
</template>
