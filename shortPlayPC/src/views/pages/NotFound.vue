        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, color-mix(in srgb, var(--primary-color), transparent 60%) 10%, var(--surface-ground) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                    ...
                    <div class="text-surface-600 dark:text-surface-200 mb-8">您请求的资源不存在。</div>
                    <router-link to="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                        ...
                        <span class="ml-6 flex flex-col">
                            ...
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">查找常见问题的答案。</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                        <span class="flex justify-center items-center border-2 border-primary text-primary rounded-border" style="height: 3.5rem; width: 3.5rem">
                        ...
                        <span class="ml-6 flex flex-col">
                            ...
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">探索我们的解决方案。</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex items-center mb-8 py-8 border-surface-300 dark:border-surface-500 border-b">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">权限管理器</span>
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">管理您的权限。</span>
                        </span>
                    </router-link>
                    <Button as="router-link" label="返回仪表盘" to="/" />
                </div>
            </div>
        </div>
    </div>
