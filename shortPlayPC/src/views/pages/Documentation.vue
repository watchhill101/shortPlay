...
<code>import { useLayout } from '@/layout/composables/layout';</code></pre>
        ...
        <ul class="leading-normal list-disc pl-8 text-lg mb-4">
            <li>
                ...
                <i class="pi pi-arrow-right !text-sm mr-1"></i> <span class="text-primary font-medium">public</span>
            </li>
            <li>
                <span class="text-primary font-medium">src/components</span>
                <i class="pi pi-arrow-right !text-sm mr-1"></i> <span class="text-primary font-medium">components</span>
            </li>
            <li>
                <span class="text-primary font-medium">src/service</span>
                <i class="pi pi-arrow-right !text-sm mr-1"></i> <span class="text-primary font-medium">service</span>
            </li>
            <li>
            ...
            <li>
                ...
                <i class="pi pi-arrow-right !text-sm mr-1"></i> <span class="text-primary font-medium">pages</span>
            </li>
        </ul>
    </div>
</template>
